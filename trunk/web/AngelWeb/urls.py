...
urlpatterns = patterns('',
    ...
    (r'^control/project/detector/', 'servers.views.project_detector'),
    ...
    (r'^api/show_widget_detail/(\d+)$', 'servers.overviews.api_show_widget_detail'),
    (r'^api/update_widget_info/$', 'servers.overviews.update_widget_info'),
    ...
    (r'^ticket/all/$', 'servers.viewstatistics.ticket_all'),
    (r'^ticket/new/$', 'servers.viewstatistics.ticket_new'),
    (r'^ticket/processing/$', 'servers.viewstatistics.ticket_processing'),
    (r'^ticket/closed/$', 'servers.viewstatistics.ticket_closed'),
    (r'^ticket/done/$', 'servers.viewstatistics.ticket_done'),
